...
const EditProfilePopup = ({ isOpen, onClose, onUpdateUser }) => {
    ...
    return (
        <PopupWithForm type='edit-profile' name='editForm' title='Редактировать профиль' button='Сохранить' isOpen={isOpen} onClose={onClose} onSubmit={handleSubmit} isValid={inputsValid}>
