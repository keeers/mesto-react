...
const EditAvatarPopup = ({ isOpen, onClose, onUpdateAvatar }) => {
    ...
    return (
        <PopupWithForm type='edit-avatar' name='editAvatarForm' title='Обновить аватар' button='Сохранить' isOpen={isOpen} onClose={onClose} isValid={inputValid} onSubmit={handleSubmit}>
